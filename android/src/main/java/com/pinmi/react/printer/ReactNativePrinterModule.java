...
public class ReactNativePrinterModule extends ReactContextBaseJavaModule {
  private Pos pos;

  public ReactNativePrinterModule(ReactApplicationContext reactContext) {
    super(reactContext);
  }

  @Override
  public String getName() {
    return "ReactNativePrinter";
  }

  private String t = "text";

  @ReactMethod
  public void print(String _ip, Integer _port, String _text) {
    final String ip = _ip;
    final Integer port = _port;
    // final Callback successCallback = _successCallback;
    // final String text = _text;
    final String[] arr = _text.split("\\|\\|\\|");
    // successCallback.invoke(Arrays.toString(arr));
    // final String[] arr = "<CM>1</CM>\n".split("\\|\\|\\|");
    new Thread() {
      public void run() {
        try {
          ...
          for (int j = 0; j < arr.length; j++) {
            ...
            // successCallback.invoke(pos.printData);
          }
